...
This README file describes how to install GLOBAL on MS-Windows systems:
	...
	htags:\
	 ...
	 :body_begin...
       ...
       Note: use slashes (or double up the backslashes) and add a backslash
	     before the drive colon.  For example:
    ...
    6. The sort.exe is from http://unxutils.sourceforge.net/.  You may remove
       it if you have another POSIX version, but it must exist in the same
       directory as the GLOBAL exes.
